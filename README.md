...
Site fictício para um hotel fins de treinamento com html e CSS

## :dart: Objetivo do Projeto

```bash
Praticar conhecimentos obre HTML5, CSS3
...
Para visualizar o site no GitHubPages <a href="https://cleuber-andrade.github.io/Projeto_Chale_hotel/" target="_blank">Clique aqui</a>

## 👷 Como rodar

```bash
# Clonar o repositório
git clone https://github.com/cleuber-andrade/Projeto_Chale_hotel.git
